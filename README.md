...
.
    ...
    |	|-- game_data_01_boxscore_pull.ipynb		   # Script to pull boxscore data   
    |	|-- game_data_02_transform.ipynb              # Script to transform the data
    |	|-- game_data_03_regression.ipynb		   # Script to run regression model  
